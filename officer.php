...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <div class="lead mt-4">
                            Officer Data <button class="shadow-sm btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createOfficer" style="float: right"><i class="fa fa-plus"></i> Create New</button>
                        </div>
        ...
        <div class="modal fade" id="createOfficer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form id="formCreateOfficer">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select shadow-sm" id="role_new">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary shadow-sm save_new_officer"><i class="fa fa-save"></i> Save</button>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <!-- Modal Update Officer -->
        <div class="modal fade" id="updateOfficer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Officer</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="formUpdateOfficer">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select shadow-sm" id="role_update">
                                            <option value="1">Superadmin</option>
                                            <option value="2">Admin</option>
                                            <option value="3">Member</option>
                                        </select>    
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary shadow-sm save_update_officer"><i class="fa fa-save"></i> Save</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <script>
            $(document).ready(async function() {
                            ...
                            response.data.forEach((item, index) => {
                                $('.tbody').append(`
                                    <tr>
                                        ...
                                        <td><span class="badge ${item.role == 'Superadmin' ? 'bg-info' : 'bg-warning'} shadow-sm">${item.role}</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-success shadow-sm btnUpdate" data-id="${item.id}" data-bs-toggle="modal" data-bs-target="#updateOfficer"><i class="fa fa-pencil"></i></button>
                ...
                $(document).on('click', '.btnDelete', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: '<?= $var->url; ?>/json/deleteofficer.php',
                                method: 'GET',
                                dataType: 'JSON',
                                data: {
                                    id: id
                                ...
                                success: () => {
                                    Toast.fire({
                                        icon: 'success',
                                        title: 'Officer has been deleted'
                                    })
                                    param.page = 1
                                    fetchData()
                                },
                                error: () => {
                                    Toast.fire({
                                        icon: 'error',
                                        title: 'Officer failed to deleted'
                                    })
                                    param.page = 1
                                    fetchData()
                                }
                ...
                $('#formCreateOfficer').on('submit', function(e) {
                    e.preventDefault()
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?= $var->url; ?>/json/createofficer.php',
                        data: formData,
                        contentType: false,
                        processData: false,
                        ...
                        success: (response) => {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Officer has been created'
                            })
                            param.page = 1
                            fetchData()
                        },
                        error: (err) => {
                            Toast.fire({
                                icon: 'error',
                                title: 'Officer failed to created'
                            })
                            param.page = 1
                            fetchData()
                        }
